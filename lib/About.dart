...
class _AboutState extends State<About> {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      appBar: AppBar(elevation: 0,   backgroundColor: Color.fromARGB(255, 31, 33, 37),
      ),
      body: Center(child: Column(
children: [
  Image.asset('assets/images/darts.png',height: 100,),
   Text('OUR MISSION',style: GoogleFonts.aDLaMDisplay(fontSize:20,color: Colors.white),),
  Container(margin: EdgeInsets.all(30),
   ...
   Text('OUR VISION',style: GoogleFonts.aDLaMDisplay(fontSize:20,color: Colors.white),),
  Container(margin: EdgeInsets.all(30),
   child:  Text('As a one-stop media shop, we want our clients to have the best of media experience that leaves our brand permanently on their mind',style: GoogleFonts.mulish(fontSize:15,color: Colors.white),
               textAlign: TextAlign.justify, 
             softWrap: true,),),
],
      ),),
